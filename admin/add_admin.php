        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
					...
					$result=mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"select * from admin WHERE username='$username' ") or die (mySQLi_error());
					...
					{		
						mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"insert into admin (firstname, middlename, lastname, username, password, confirm_password, admin_image, admin_type, admin_added)
