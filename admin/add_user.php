<?php include ('header.php'); ?>
		...
		//							$profile=$_FILES["image"]["name"];
					...
					$result=mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"select * from user WHERE school_number='$school_number' ") or die (mySQLi_error());
					...
					{		
						mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"insert into user (school_number,firstname, middlename, lastname, contact, gender, address, type, level, section, status, user_added)
