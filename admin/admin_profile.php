...
<?php
$user_query  = mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"select * from admin where admin_id = '$id_session'")or die(mysqli_error());
...
?>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<?php
							$result= mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"select * from admin where admin_id = '".$_SESSION['id']."' order by admin_id DESC") or die (mysqli_error());
