                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<?php
							$result= mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"select * from book order by book_id DESC ") or die (mysqli_error());
							while ($row= mysqli_fetch_array ($result) ){
							$id=$row['book_id'];
							$category_id=$row['category_id'];
							
							$cat_query = mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"select * from category where category_id = '$category_id'")or die(mysqli_error());
