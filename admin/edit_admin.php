            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <!-- content starts here -->
<?php
  $query=mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"select * from admin where admin_id='$ID'")or die(mysqli_error());
...
$result=mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"select * from admin") or die (mySQLi_error());
...
{
mysqli_query(mysqli_connect("localhost","root","0562324","lms")," UPDATE admin SET firstname='$firstname', middlename='$middlename', lastname='$lastname', username='$username', password='$password', 
