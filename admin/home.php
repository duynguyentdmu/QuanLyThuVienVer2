        ...
        <div class="clearfix"></div>
                ...
                <div class="row tile_count" style="margin-right:-245px;">
					 <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                        ...
                        <div class="right">
							<?php
							$result = mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"SELECT * FROM admin");
				...
				<a href="admin.php">
					...
					<div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                        ...
                        <div class="right">
							<?php
							$result = mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"SELECT * FROM user");
							$num_rows = mysqli_num_rows($result);
							?>
				<a href="user.php">
					...
					<div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                        ...
                        <div class="right">
							<?php
							$result = mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"SELECT * FROM book");
							$num_rows = mysqli_num_rows($result);
							?>
				<a href="book.php">
					...
					<div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                        ...
                        <div class="right">
							<?php
							$result = mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"SELECT * FROM borrow_book");
							$num_rows = mysqli_num_rows($result);
							?>
				<a href="borrowed.php">
					...
					<div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                      <div class="left"></div>
                        <div class="right">
							<?php
							$result = mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"SELECT * FROM return_book");
							$num_rows = mysqli_num_rows($result);
							?>
