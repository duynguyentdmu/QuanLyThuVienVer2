...
<?php // 	include ('add_modal_example_2.php'); ?>
                                ...
                                <div class="x_content">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
							<?php
							$penalty_query= mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"select * from penalty order by penalty_id DESC ") or die (mysqli_error());
							...
							?>
									...
									<div class="modal-dialog">
										...
										<div class="modal-body">
												<?php
												$query2=mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"select * from penalty where penalty_id='$penalty_id'")or die(mysqli_error());
												...
												<?php
													...
													{
														mysqli_query (mysqli_connect("localhost","root","0562324","lms")," UPDATE penalty SET penalty_amount='$penalty_amount1' ") or die (mysqli_error());
													}
													{
