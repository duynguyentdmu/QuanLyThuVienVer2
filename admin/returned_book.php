		...
		<!--- sort -->
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">							
							<?php
							$return_query= mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"select * from return_book 
							...
							$count_penalty = mysqli_query(mysqli_connect("localhost","root","0562324","lms"),"SELECT sum(book_penalty) FROM return_book ")or die(mysqli_error());
