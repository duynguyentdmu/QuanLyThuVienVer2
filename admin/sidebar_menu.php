            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    ...
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="home.php" class="site_title"><i class="fa fa-university"></i> <span>THƯ VIỆN THPT ABC</span></a>
                    </div>
...
<?php } ?>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        ...
                        <div class="menu_section">
							<h3 style="margin-top:85px;">Thông tin File</h3>
...
?>
                        ...
                        <div class="menu_section">
                            <h3>thông tin giao dịch</h3>
							<div class="separator"></div>
                            <ul class="nav side-menu">
                                <li>
									<a href="borrow.php"><i class="fa fa-edit"></i> Cho mượn sách</a>
                                </li>
                                <li>
									<a href="borrowed.php"><i class="fa fa-book"></i> Sách đã mượn</a>
                                </li>
                                <li>
									<a href="returned_book.php"><i class="fa fa-book"></i> Sách Trả</a>
                                </li>
                                <li>
									<a href="settings.php"><i class= "fa fa-cog"></i> Cài đặt</a>
                                </li>
                                <li>
									<a href="report.php"><i class= "fa fa-file"></i> Báo cáo</a>
                                </li>
                                <li>
									<a href="about_us.php"><i class= "fa fa-info"></i> Thông tin</a>
                                </li>
                               <!--- <li>
